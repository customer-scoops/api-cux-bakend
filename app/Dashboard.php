...
class Dashboard extends Generic
{
    ...
    private function graphCsatTransvip($graphCSAT)
    {
        ...
        $drivers = [
            'Canal', 'Tiempo encontrar un conductor', 'Coordinación en Andén', 'Puntualidad del servicio', 'Tiempo llegada del vehículo',
    ...
    public function detailsDash($request, $jwt)
    {
        ...
        if ($this->_dbSelected  == 'customer_banmedica') {
            ...
            } else   if ($db == 'adata_ban_asi' || $db == 'adata_vid_asi' || $db == 'adata_vid_con' || $db == 'adata_ban_con') {
            ...
            } else            if ($db == 'adata_ban_con' || $db == 'adata_vid_con') {
            ...
            } else            if ($db == 'adata_ban_suc' || $db == 'adata_vid_suc') {
